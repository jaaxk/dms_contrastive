...
for COARSE_SELECTION_TYPE in "Stability" "Expression" ; do
    ...
    python -u pipeline.py --run_name $RUN_NAME \
        ...
        --model_path /gpfs/home/jv2807/dms_contrastive/results/650M_splitbygene_NWT_lora_${COARSE_SELECTION_TYPE}_layer33_mean/model.pt \
        --ohe_baseline
